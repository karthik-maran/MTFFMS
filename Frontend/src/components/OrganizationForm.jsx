...
function OrgForms({setToggleForm}){
   ...
   async function handleSubmit(e){
        e.preventDefault();
        try {
            const response =  await axios.post(`${API_URL}/api/org/add`,{organizationName :name,organizationDomain:orgDomain});
    ...
    return(
        ...
        <div className="h-fit w-150 rounded-md shadow-md p-5 bg-gray-100">
            ...
            <div className="flex flex-col w-full gap-2 mt-5">
                ...
                <input type="text" placeholder=" organizations name" className="p-2 border-2 border-gray-400 rounded-lg p-1 hover:border-purple-300  focus:outline-purple-300" onChange={(e)=>setName(e.target.value)}></input>
            </div>
               <div className="flex flex-col w-full gap-2 mt-5">
